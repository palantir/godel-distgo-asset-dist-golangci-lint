...
./godelw exec -- go get github.com/securego/gosec/v2

Output:
go: module github.com/securego/gosec/v2: Get "https://proxy.golang.org/github.com/securego/gosec/v2/@v/list": dial tcp 142.251.211.209:443: i/o timeout
Error: exit status 1
